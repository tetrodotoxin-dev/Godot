...
#include "demo/adapters/imaging/scripts/image.hpp"
...
Adapters::Imaging::Scripts::Image::Image(
    ...
    : Godot::Demo::Imaging::Publication::Image(allocation, width, height),
      object(object),
...
Adapters::Imaging::Scripts::Image::Image(
    ...
    const Image& source,
    const godot::Ref<godot::RefCounted>& object)
    : Godot::Demo::Imaging::Publication::Image(allocation, source),
      object(object),
      publication(object.ptr(), "fulfill"),
      pixels(object.ptr(), "read_pixels") {}
...
auto Adapters::Imaging::Scripts::Image::fulfill(
    ...
    -> Ttx::Semantic::Negotiation::Binding::Status {
  if (contract == Godot::Demo::Imaging::Contracts::Invert::contract_id) {
    ...
    return Ttx::Semantic::Negotiation::Binding::provide<
        Godot::Demo::Imaging::Contracts::Invert>(
        Godot::Demo::Imaging::Contracts::Invert::Api(this, &table), requested);
  }

  if (contract == Godot::Demo::Imaging::Contracts::Convolve::contract_id) {
    ...
    return Ttx::Semantic::Negotiation::Binding::provide<
        Godot::Demo::Imaging::Contracts::Convolve>(
        Godot::Demo::Imaging::Contracts::Convolve::Api(this, &table),
        requested);
  }

  if (contract == Godot::Demo::Imaging::Contracts::Composite::contract_id) {
    ...
    return Ttx::Semantic::Negotiation::Binding::provide<
        Godot::Demo::Imaging::Contracts::Composite>(
        Godot::Demo::Imaging::Contracts::Composite::Api(this, &table),
        requested);
  }
  ...
  const auto publish = [&]() {
    ...
    case IMAGE_INPUT_NONE: {
      ...
      return Binding::provide<Godot::Demo::Imaging::Contracts::Invert>(
          Godot::Demo::Imaging::Contracts::Invert::Api(value, &operations),
          requested);
    }
    case IMAGE_INPUT_KERNEL: {
      ...
      return Binding::provide<Godot::Demo::Imaging::Contracts::Convolve>(
          Godot::Demo::Imaging::Contracts::Convolve::Api(value, &operations),
          requested);
    }
    case IMAGE_INPUT_IMAGE: {
      ...
      return Binding::provide<Godot::Demo::Imaging::Contracts::Composite>(
          Godot::Demo::Imaging::Contracts::Composite::Api(value, &operations),
          requested);
    }
    }
...
auto Adapters::Imaging::Scripts::Image::composite(
  ...
  // module.
  return Godot::Demo::Imaging::Contracts::Pixels::read(overlay).visit(
...
auto Adapters::Imaging::Scripts::Image::visit_offers(
  ...
  if (!object->has_method("offers")) {
    return Godot::Demo::Imaging::Publication::Image::visit_offers(visitor);
  }
...
auto Adapters::Imaging::Scripts::Image::admit(
  ...
  if (!object->has_method("admit")) {
    return Godot::Demo::Imaging::Publication::Image::admit(
