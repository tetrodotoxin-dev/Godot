...
auto Imaging::Cuda::Runtime::create()
...
void Imaging::Cuda::Runtime::retain() {
  Core::Object<>(reinterpret_cast<U8*>(this)).retain();
}

void Imaging::Cuda::Runtime::release() {
  Core::Object<>(reinterpret_cast<U8*>(this)).release();
}

auto Imaging::Cuda::Runtime::prepare() -> Core::View::Bytes {
...
auto Imaging::Cuda::Runtime::allocate(Count size)
...
auto Imaging::Cuda::Runtime::write(CUdeviceptr data, Core::View::Bytes bytes)
    -> Core::View::Bytes {
  ::Cuda::Runtime::CurrentContext current(context);
  if (current.status != CUDA_SUCCESS) {
    return driver_error(current.status);
...
auto Imaging::Cuda::Runtime::upload(Core::View::Bytes bytes)
    -> Utility::Result<CUdeviceptr, Core::View::Bytes> {
...
auto Imaging::Cuda::Runtime::read(CUdeviceptr data, Core::Access::Bytes target)
    -> Core::View::Bytes {
  ::Cuda::Runtime::CurrentContext current(context);
  if (current.status != CUDA_SUCCESS) {
    return driver_error(current.status);
...
void Imaging::Cuda::Runtime::free_image(CUdeviceptr data) {
  ::Cuda::Runtime::CurrentContext current(context);
  if (current.status != CUDA_SUCCESS) {
...
auto Imaging::Cuda::Runtime::finish() -> Core::View::Bytes {
  ::Cuda::Runtime::CurrentContext current(context);
  if (current.status != CUDA_SUCCESS) {
    return driver_error(current.status);
  }
