...
Gdextension::Classes::Class::Class(
...
auto Gdextension::Classes::Class::get_query() const -> ttx_semantic_query {
  return {
    this,
    [](const void* source, perimortem_uuid id,
       ttx_storage requested) -> ttx_binding_status {
      if (System::Uuid(id) != ::Gdextension::Contracts::Class::contract_id) {
      ...
      return static_cast<ttx_binding_status>(
          Ttx::Semantic::Negotiation::Binding::provide<
              ::Gdextension::Contracts::Class>(
              godot_class(source, &operations),
              Ttx::Data::Form::Storage(requested)));
    },
    [](const void*, perimortem_uuid id) -> ttx_binding_status {
      return System::Uuid(id) == ::Gdextension::Contracts::Class::contract_id
                 ? TTX_BINDING_SATISFIED
                 : TTX_BINDING_UNSUPPORTED;
    }};
}

auto Gdextension::Classes::Class::publish() -> Ttx::Data::Status {
  ...
  godot::internal::gdextension_interface_classdb_register_extension_class5(
      godot::internal::library, name._native_ptr(), base._native_ptr(), &info);
...
auto Gdextension::Classes::Class::create(void* source, GDExtensionBool notify)
        ...
        return Instance::create(type, Core::Data::take(publication))
            .visit(
                [&](Instance* instance) -> GDExtensionObjectPtr {
                  ...
                  if (notify) {
                    static const auto method = godot::internal::
...
auto Gdextension::Classes::Class::destroy(
    void*,
...
Gdextension::Classes::Class::~Class() {
  ...
  if (published) {
    godot::internal::gdextension_interface_classdb_unregister_extension_class(
        godot::internal::library, name._native_ptr());
  }
}
