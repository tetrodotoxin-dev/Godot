...
static auto description(U32 index) -> ttx_callable_description {
  ...
  return {
    ...
    {&Plugins::Render::Runtime::input(index), upload, index == 0 ? 3U : 0U},
    {&Plugins::Render::Runtime::output(index), &returned[index], 1}};
}
...
class Export {
 public:
  Export* root;
  U32 index;
  Plugins::Render::Module::OpenImages images;
    ...
    if (index == 1 &&
      ...
      static const ttx_extensible_operations operations = {
        [](const void* source, ttx_publication* output) {
          return Plugins::Render::Runtime::emit(
...
class Discovery {
 public:
  Discovery(
      Plugins::Render::Module::OpenImages images,
      Plugins::Render::Module::OpenSamples samples,
...
auto Plugins::Render::Module::open(
    OpenImages images,
    OpenSamples samples,
